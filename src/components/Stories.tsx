...
import { 
  ...
  Radio, Loader2, ImageIcon, Play, Shield, ArrowLeft, Star, Save, CameraOff
} from "lucide-react";
        ...
        {showCamera && (
          <div className="fixed inset-0 z-[250] bg-black flex flex-col items-center justify-center">
            ...
            <div className="absolute bottom-10 flex gap-10 items-center">
              <Button onClick={stopCamera} variant="ghost" className="bg-white/10 rounded-full h-16 w-16"><X className="w-8 h-8 text-white" /></Button>
