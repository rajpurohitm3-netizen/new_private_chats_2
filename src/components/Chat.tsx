    ...
    <div className="flex flex-col h-full bg-[#030303] relative overflow-hidden select-none" onContextMenu={(e) => e.preventDefault()}>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6 no-screenshot relative">
        ...
        <div className="absolute bottom-4 left-6 z-10 pointer-events-none">
          <AnimatePresence>
            {(partnerPresence.isInChat || partnerPresence.isTyping) && (
              <motion.div
              ...
              >
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    className="w-3 h-3 bg-blue-500 rounded-full border border-blue-400/50 shadow-[0_0_15px_rgba(59,130,246,0.5)] relative z-10"
                  />
                </div>
                <span className="text-[8px] font-black uppercase tracking-[0.3em] text-blue-400 drop-shadow-[0_0_5px_rgba(59,130,246,0.3)]">
